...
var text2 = ''
var arr = []
const LandingRecommendedPost = ({ dataItem ,userDataId ,deleteToList ,addToList ,tab1=false }) => {
        ...
        <div className="landing-recommended-left">
          ...
          <div className="landing-footer">
            ...
            {dataItem.user_id == parseInt(userDataId)  ? (
              <Tooltip title="Save" >
                <span onClick={()=>deleteToList(dataItem.id,dataItem.post_id)}>
                  <svg
                    width="25"
                    height="25"
                    viewBox="0 0 25 25"
              ...
              <Tooltip title="Save" >
                <span onClick={()=>addToList(dataItem.id)}>
                  <svg
                    width="25"
                    height="25"
                    viewBox="0 0 25 25"
