...
class SessionForm extends React.Component {
        ...
        <div className="signup-names">
          <div className="signup-names-input">
            <input
              ...
              className={
                this.props.errors.name ? "login-input errors" : "login-input"
              }
              placeholder="Name"
            />
          </div>
          ...
          <div
            className={this.props.errors.name ? "error-messages name" : null}
            id="fname"
          >
      ...
      return (
        <div className="birthday-parent-container">
          ...
          <input
            ...
            className={
              this.props.errors.birthday ? "login-input errors" : "login-input"
            }
          />
          <div
            className={
  ...
  displayPasswordError() {
    if (this.props.formType === "Log In" && this.props.openModal) {
      ...
      return (
        <div className="error-messages password">
  ...
  displayEmailError() {
    if (this.props.formType === "Log In" && this.props.openModal) {
      ...
      return (
        <div className="error-messages email">{this.props.errors.email}</div>
      );
    }
  }
  ...
  render() {
    return (
      <div className="login-form-container">
        ...
        <form onSubmit={this.handleSubmit} className="login-form-box">
          ...
          <div className="login-form">
            ...
            <input
              ...
              className={
                (this.props.errors.email && !this.props.openModal) ||
                (this.props.errors.login && !this.props.openModal)
                  ? "login-input errors"
                  : "login-input"
              }
              placeholder="Email"
            ...
            <div className="password-container">
              <input
                ...
                className={
                  (this.props.errors.password && !this.props.openModal) ||
                  (this.props.errors.login && !this.props.openModal)
                    ? "login-input errors"
                    : "login-input"
                }
        ...
        {this.props.formType === "Log In" ? (
          <button className="button-create" onClick={this.openModal}>
            Create New Account
          </button>
        ) : null}
      </div>
